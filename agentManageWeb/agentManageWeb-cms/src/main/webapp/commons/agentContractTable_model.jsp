    ...
    <table  class="grid">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="javascript:void(0)" class="addAgentContractTableAttr-easyui-linkbutton-edit" data-options="plain:true,iconCls:'fi-magnifying-glass'" onclick="addAgentContractTable_uploadView(this)" >添加附件</a>
            </td>
        </tr>
        </tbody>
    </table>
