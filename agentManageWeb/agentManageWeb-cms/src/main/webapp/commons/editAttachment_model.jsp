...
<div class="easyui-panel" title="附件信息"  data-options="iconCls:'fi-results'" id="attachmentItemTableForm">
    <table class="grid" >
        <tr>
            ...
            <td colspan="4">
                <a href="javascript:void(0)" class="busck-easyui-linkbutton-edit" data-options="plain:true,iconCls:'fi-magnifying-glass'" onclick="addAttAgentcapitalTable_uploadView(this)" >添加附件</a>
            </td>
        </tr>
    </table>
</div>
<script type="application/javascript">
    ...
    //上传窗口
    function addAttAgentcapitalTable_uploadView(t){
        addAttAgentcapitalTable_attrDom = $(t).parent().parent().find(".attrInput");
        multFileUpload(addAttAgentcapitalTable_jxkxUploadFile);
    }
    //附件解析
