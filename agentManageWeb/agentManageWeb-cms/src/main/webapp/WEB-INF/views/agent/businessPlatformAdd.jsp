...
<div class="easyui-panel" data-options="iconCls:'fi-results'">
    ...
    <table class="grid">
        <tr>
            <td>唯一编码:
                <input id="agUniqNum" maxlength="25" type="text" placeholder="请输入" class="easyui-validatebox" data-options="required:true" style="width:160px;margin-left: 10px">
