        ...
        dictA = $('#dictA').datagrid({
            ...
            columns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                    <%--<shiro:hasPermission name="/dict/queryDict">
                        str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                        str += $.formatString('<a href="javascript:void(0)" class="dict-easyui-linkbutton-query" data-options="plain:true,iconCls:\'fi-magnifying-glass icon-blue\'" onclick="queryPlatFormFun(\'{0}\');" >查看</a>', row.id);
                    </shiro:hasPermission>--%>
...
//                $('.dict-easyui-linkbutton-query').linkbutton({text:'查看'});
...
//            maximizable:true,
    ...
    <%--// 查看--%>
    <%--function queryDictFun(id) {--%>
    <%--parent.$.modalDialog({--%>
    <%--title : '查看',--%>
    <%--width : 800,--%>
    <%--height : 420,--%>
    <%--href : '${path }/dict/queryDictPage?id=' + id,--%>
    <%--});--%>
    <%--}--%>
</script>
    ...
    <div data-options="region:'north',border:false" style="height: 35px; overflow: hidden;background-color: #fff">
        <form id ="searchDictForm">
            <table>
                <tr>
                    <th>字典类型:</th>
                    <td><input name="dGroup" id="dGroup" style="line-height:17px;border:1px solid #ccc"></td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <th>字典编号:</th>
                    <td><input name="dArtifact" id="dArtifact" style="line-height:17px;border:1px solid #ccc"></td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td>
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="searchDict();">查询</a>
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-x-circle',plain:true" onclick="cleanDict();">清空</a>
                    </td>
                </tr>
            </table>
        </form>
