    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="posRewardTempEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>活动生效月份：</td>
                    <td><input type="text" id="activityValid" name="activityValid" maxlength="48"  style="width:300px;" value="${posRewardTemplate.activityValid}"  placeholder="请输入活动生效日期" class="easyui-validatebox" data-options="required:true">
