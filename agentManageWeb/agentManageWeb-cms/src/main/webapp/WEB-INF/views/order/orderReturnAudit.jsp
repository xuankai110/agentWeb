    ...
    <shiro:hasPermission name="refund_apr_permission_addkk">
        <c:if test="${sid=='sid-C911F512-9E63-44CC-9E6E-763484FA0E5B'}">
            <table class="grid" style="width: 100%;margin-top: 30px">
                <tr>
                    <td><b><a href="#" onclick="openPlanerListPage()">添加排单</a>&nbsp;&nbsp;&nbsp;&nbsp;</b>
                    </td>
                </tr>
            </table>
...
<script type="text/javascript">
    ...
    function openPlanerListPage() {
        ...
        parent.$.modalDialog({
            ...
            height : '80%',
            maximizable: true,
            href: '${path }/order/return/page/planerList',
            buttons: [{
                text: '关闭',
                handler: function () {
                    parent.$.modalDialog.handler.dialog('close');
    ...
    $(function () {
        receipPlanDataGrid_b = $('#paidan_complate_b').datagrid({
            url: '${path }/receiptPlan/list?returnId=' + returnId,
            striped: true,
            rownumbers: true,
            pagination: true,
            singleSelect: true,
