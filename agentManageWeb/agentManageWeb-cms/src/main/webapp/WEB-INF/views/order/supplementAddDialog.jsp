    ...
    <form id="supplementAdd">
        ...
        <table class="grid">
            ...
            <tr>
                ...
                <td>付款金额</td>
                <td><input name="payAmount" type="text" class="easyui-validatebox" style="width:120px;"
                           value="${oSupplement.payAmount}" readonly="readonly"
                           data-options="required:true,validType:['length[1,20]','Money']"/>元
                </td>
            </tr>
        </table>
    </form>
