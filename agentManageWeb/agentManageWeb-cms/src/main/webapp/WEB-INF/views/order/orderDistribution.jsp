...
//        ar.push('<td>');ar.push(data.ID);ar.push('</td>');
        ...
        ar.push('<select style="width: 200px;"  onchange="subOrderAddressChange(this,\''+data.ID+'\')">');
          $.each(all.address,function(i,n){
                ...
                ar.push(n.addrRealname);ar.push(n.addrMobile);
                ar.push(n.addrProvinceString);ar.push(n.addrCityString);ar.push(n.addrDistrictString);
                ar.push('</option>');
            });
        ar.push('</select>');
        ar.push('</td>');
...
<div>
    ...
    <div id="yphspFooter" style="text-align: right;">
        <a onclick="sureSendActionALL('${orderId}','${agentId}')" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'fi-folder-add icon-red'">确定发货</a>
    </div>
</div>
