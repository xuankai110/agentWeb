        ...
        <form id="productAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>机具类型：</td>
                    <td>
                        <select class="easyui-combobox"  name="proType" editable="false"  style="width:160px;" data-options="required:true">
                    ...
                    <td>厂商：</td>
                    <td>
                        <select class="easyui-combobox"  name="proCom" editable="false"  style="width:160px;" data-options="required:true">
                ...
                <tr>
                    <td>型号：</td>
                    <td><input name="proModel" maxlength="15" type="text" placeholder="请输入" class="easyui-validatebox" data-options="required:true" style="width:160px;"></td>
                    <td>单价：</td>
                    <td><input name="proPrice" maxlength="15" type="text" placeholder="请输入" maxlength="11" precision="2" class="easyui-numberbox" data-options="required:true" style="width:160px;"></td>
                </tr>
                <tr>
                    <td>状态：</td>
                    <td>
