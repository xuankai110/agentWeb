        ...
        <form id="productEditForm" method="post">
            ...
            <table class="grid">
                ...
                <tr>
                    ...
                    <td>厂商：</td>
                    <td>
                        <select class="easyui-combobox" name="proCom" editable="false" style="width:160px;"
                                data-options="required:true">
                            <c:forEach items="${manufacturer}" var="manufacturerItem">
                                <option value="${manufacturerItem.dItemvalue}"
                                        <c:if test="${manufacturerItem.dItemvalue == oProduct.proCom}">selected="selected"</c:if> >${manufacturerItem.dItemname}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td>型号：</td>
                    <td><input name="proModel" value="${oProduct.proModel}" maxlength="15" type="text" placeholder="请输入"
                               class="easyui-validatebox" data-options="required:true" style="width:160px;"></td>
                    <td>单价：</td>
